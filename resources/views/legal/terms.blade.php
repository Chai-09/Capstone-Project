...
<div class="container py-5 w-100">
    ...
    <div class="content">
        <div class="header">Interpretation</div>
        <div class="explain">The words of which the initial letter is capitalized have meanings defined 
        under the following conditions. The following definitions shall have the same 
        meaning regardless of whether they appear in singular or in plural.</div>
    </div> 
    ...
    <div class="content">
        ...
        <div class="explain">
            ...
            <p>Application means the software program provided by the Company downloaded by You on any electronic device, named ApplySmart.</p>
            ...
            <p>Country refers to: Philippines.</p>

            <p>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to FEU Diliman, Sampaguita Avenue, Mapayapa Village, Diliman, Quezon City, Philippines.</p>
            ...
            <p>Website refers to ApplySmart, accessible from <a href="https://applysmart.feudiliman.edu.ph" target="_blank" rel="noopener noreferrer">applysmart.feudiliman.edu.ph</a>.</p>
    ...
    <div class="content">
        <div class="header">Acknowledgment</div>
        <div class="explain">
    ...
    <div class="content">
        <div class="header">Links to Other Websites</div>
        <div class="explain">
    ...
    <div class="content">
        <div class="header">Termination</div>
        <div class="explain">
    ...
    <div class="content">
        <div class="header">Limitation of Liability</div>
        <div class="explain">
            <p>Notwithstanding any damages that You might incur, the entire liability of the Company and any of its suppliers under any provision of this Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by You through the Service or 5650 PHP if You haven't purchased anything through the Service.</p>
    ...
    <div class="content">
        <div class="header">"AS IS" and "AS AVAILABLE" Disclaimer</div>
        <div class="explain">
   ...
   <div class="content">
        <div class="header">Disputes Resolution</div>
        <div class="explain">
    ...
    <div class="content">
        <div class="header">For European Union (EU) Users</div>
        <div class="explain">
    ...
    <div class="content">
        <div class="header">United States Legal Compliance</div>
        <div class="explain">
    ...
    <div class="content">
        <div class="header">Severability</div>
        <div class="explain">
    ...
    <div class="content">
        <div class="header">Translation Interpretation</div>
        <div class="explain">
    ...
    <div class="content">
        <div class="header">Changes to These Terms and Conditions</div>
        <div class="explain">
