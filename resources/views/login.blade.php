                            ...
                            <div class="form-group">
                                ...
                                <div class="name-fields">
                                    <div class="name-field">
                                        <input type="text" name="guardian_fname" id="guardian_fname" placeholder="First Name" required>
                                    </div>
                                    <div class="name-field">
                                        <input type="text" name="guardian_mname" id="guardian_mname" placeholder="Middle Name" value="{{ old('guardian_mname') }}">
                                    </div>
                                    <div class="name-field">
                                        <input type="text" name="guardian_lname" id="guardian_lname" placeholder="Last Name" required>
                                    </div>
                                </div>
                            </div>
